                  ...
                  <div className="space-y-4">
                    <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                      ...
                      <p className="text-sm text-green-700">
                        You now earn a <strong>10% commission</strong> on every successful booking from your affiliate links.
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                      ...
                      <div className="text-sm text-blue-700 space-y-1">
                        ...
                        <p>• You earn <strong>10% commission</strong> on every successful booking</p>
                        ...
                        <p>Your commission: <strong>3,000 PKR</strong> (10%)</p>
                      </div>
                    </div>
